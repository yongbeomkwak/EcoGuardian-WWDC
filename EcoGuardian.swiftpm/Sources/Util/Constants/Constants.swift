...
struct Conversation {
    ...
    static let hero1:[Message] = [Message(isImage: false, content: "I am EcoBird and environmenatl protector"),Message(isImage: false, content: "Carborn is the main cause of the Greenhouse effect"),Message(isImage: false, content: "Greenhouse effect is Greenhouse gas wraps the earth like blanket and"),Message(isImage: false, content: "increase the earth's temperature"),Message(isImage: false, content: "Pictures above shows what happended the earth's temperature gets increase"),Message(isImage: false, content: "and these are just few of example")]
    ...
    static let hero2:[Message] = [Message(isImage: false, content: "if we can balance the carbon produce and absorb amount"),Message(isImage: false, content: "the situation will not get worse."),Message(isImage: false, content: "One tree can absorb 48 pounds of Co2 annually"),Message(isImage: false, content: "And if we conserve energy/electricity, that has effect of planting 4.7 trees per year!"),Message(isImage: false, content: "Let's use the same concept for game content")]
    ...
    static let howtoPlay:[Item] = [
        ...
        Item(item: "bulb", content: ["Each turned off light bulb I eat","Ut will reduce 20% of carbon"]),
        Item(item: "tree", content: ["Each tree I eat","It will reduce 10% of carbon"]),
        
        Item(item: "villain", content: ["Each carbon cloud I eat","Ut will increase 10% of carbon"])]
